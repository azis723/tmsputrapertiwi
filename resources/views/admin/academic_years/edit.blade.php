...
@section('page-title', 'Edit Tahun Akademik: ' . $academicYear->name)
@section('page-subtitle', 'Perbarui detail nama atau semester')
...
<div class="max-w-xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('admin.academic-years.update', $academicYear) }}" class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            <label class="flex items-center gap-3 cursor-pointer">
                ...
                <span class="text-sm text-slate-300 font-medium">Jadikan tahun akademik aktif</span>
            </label>
        </div>
