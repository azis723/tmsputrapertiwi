...
@section('page-title', 'Tambah Slot Waktu Belajar')
@section('page-subtitle', 'Tentukan hari, jam mulai, dan jam selesai pembelajaran')
...
<div class="max-w-xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('admin.schedule-times.store') }}" class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <input type="time" name="start_time" id="start_time" value="{{ old('start_time', '07:00') }}" required
            ...
            <div>
                ...
                <input type="time" name="end_time" id="end_time" value="{{ old('end_time', '08:30') }}" required
                       class="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm font-mono">
