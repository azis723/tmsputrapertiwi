...
@section('page-subtitle', 'Setup rombel, jurusan, tahun akademik, dan penugasan wali kelas')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('admin.classes.store') }}" class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
        @csrf

        <div>
            <label for="name" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Nama Kelas</label>
            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Contoh: X RPL 1"
