...
@section('page-subtitle', 'Perbarui tanggal atau keterangan libur')
...
<div class="max-w-xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('admin.holidays.update', $holiday) }}" class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
        @csrf
        @method('PUT')
